        ...
        <Row>
          ...
          <Col lg='6'>
            <div className="car__info">
              ...
              <div className="d-flex align-items-content gap-5 mb-4 mt-3">
                <h6 className="rent__price fw-bold fs-4"> Rs. {singleCarItem.price}.00 / Day
                </h6>
          ...
          <Col lg='7' className="mt-5">
            <div className="booking-info mt-5">
              <h5 className="mb-5 fw-bold">Booking Information</h5>
              <BookingForm />
            </div>
          </Col>
          ...
          <Col lg='5' className="mt-5">
            <div className="payment__info mt-5">
              <h5 className="mb-5 fw-bold">Payment Information</h5>
              <PaymentMethod />
            </div>
          </Col>
        </Row>
